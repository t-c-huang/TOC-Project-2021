...
def handle_message(event):
    ...
    if uid not in machine_dict.keys():
        income_record = dict.fromkeys(sat.state_fathers_family + sat.state_mothers_family, 0)
        expense_record = dict.fromkeys(sat.state_fathers_family + sat.state_mothers_family, 0)
